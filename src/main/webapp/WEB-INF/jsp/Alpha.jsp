			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Alpha ÇöÈ²</h1>
					</div>

					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Alpha Table</h6>
						</div>
						<div class="card-body">
							<div class="chart-area" style="width: 100%; height: 200%;">
								<div id="A_table_div" style="width: 100%; height: 200%;"></div>
							</div>
						</div>
					</div>
				</div>
